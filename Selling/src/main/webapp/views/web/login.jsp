				...
				<div class="col-md-6 right-box">
					<div class="row align-items-center">
						<div class="header-text mb-4 text-center">
							<h1 style="font-size: 2rem;">ĐĂNG NHẬP</h1>
						</div>
							...
							<div class="input-group mb-5 d-flex justify-content-between">
								<div class="form-check">
									<input type="checkbox" class="form-check-input" id="formCheck"
										...
										class="form-check-label text-secondary"><small>Nhớ mật khẩu</small></label>
								</div>
								<div class="forgot">
									<small><a
										href="${pageContext.request.contextPath }/web/forgotpass">Quên mật khẩu?</a></small>
								</div>
							</div>
							<div class="input-group mb-3">
						...
						<div class="input-group mb-5">
							<button class="btn btn-lg btn-light w-100 fs-6">
								<img
									...
									style="width: 20px" class="me-2"><small>Đăng nhập với Google</small>
							</button>
						</div>
